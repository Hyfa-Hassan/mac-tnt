...
export const Form = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        console.log("called")
        const { name, email, phone, subject, message } = inputsAll;
        // console.log(inputsAll)
                        ...
                        <div className="contact-grid-item">
                            ...
                            <form method='post' ref={formRef} className="contact-form" id="contactForm" onSubmit={handleSubmit}>
                                ...
                                <div className="col-12">
                                    <button className="btn main-btn main-btn-arrow" type="submit" value="submit">Send Message <i className="flaticon-right-arrow"></i></button>
