...
return(
    <>
    <div className='tournav' style={{backgroundColor:"rgba(0, 0, 0, 0.5)", height:"50px"}}></div>
                ...
                <div className="details-card">
                    <div className="row align-items-center">
                        <div className="col-lg-6">
                            <div className="details-card-image-carousel owl-carousel owl-theme default-owl-theme">
                                <div className="item">
                        ...
                        <div className="col-lg-6 desk-pad-left-40">
                            <div className="details-card-content">
                                ...
                                <a href="/enquire-form" className="btn main-btn main-btn-arrow">Book This Tour <i className="flaticon-right-arrow"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
