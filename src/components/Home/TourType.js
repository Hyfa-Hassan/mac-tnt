                ...
                <div className="tour-video-item desk-pad-right-70 order-2 order-lg-1">
                    <div className="tour-video-bg">
                        <div className="video-icon">
                            <a href="https://www.youtube.com/watch?v=pqEO5r-Vlpo" className="video-popup">
                    ...
                    <div className="max-685 m-auto me-lg-0 ms-lg-0">
                        ...
                        <div className="about-content-item">
                            ...
                            <div className="about-content-texts">
                                ...
                                <p>We are one of the main Mumbai based travel service offering a wide exhibit of movement administrations to the singular vacationers, families and gatherings. We have practical experience in inbound homegrown the travel industry to all objections inside India.</p>
                            </div>
                        </div>
                        <div className="text-center text-lg-start">
                            {/* <a href="tour.html" className="btn main-btn main-btn-arrow">Book A Tour <i className="flaticon-right-arrow"></i></a> */}
                            <Link to="/tours" className="btn main-btn main-btn-arrow">Book A Tour <i className="flaticon-right-arrow"></i></Link>
                        </div>
                    </div>
                </div>
            </div>
