                    ...
                    <div className="row align-items-center">
                        <div className="col footer-lower-item">
                            <div className="footer-copyright-text">
                                <p>Copyright ©2023 Reserved By <a href="https://maclareenai.com/" target="_blank" rel="noopener noreferrer" style={{color:"#eb2427"}}>Maclareen AI Innovation</a></p>
                            </div>
                        </div>
                        <div className="col footer-lower-item footer-lower-right">
                            ...
                            <ul className="social-list">
                                ...
                                {/* <li>
                                    <a href="https://www.youtube.com/channel/UCe2MB576T0HlK9TT6DV-K8A" target="_blank" rel="noopener noreferrer" ><i className="flaticon-twitter"></i></a>
                                </li>
                                <li>
